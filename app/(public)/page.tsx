...
export default function Home() {
  return (
      <main className="mx-auto max-w-6xl space-y-16 px-4 py-10 lg:space-y-24 lg:px-0">
          {/* HERO */}
          <section className="grid gap-10 rounded-3xl border border-slate-800 bg-gradient-to-b from-slate-950 to-slate-900/80 px-6 py-10 shadow-xl lg:grid-cols-[1.4fr,1fr] lg:px-10 lg:py-12">
              <div className="space-y-6">
                  <Badge className="rounded-full bg-emerald-500/15 px-3 py-1 text-[11px] font-medium uppercase tracking-[0.16em] text-emerald-300">
                      Autoconsommation collective
                  </Badge>

                  <h1 className="text-3xl font-semibold leading-tight text-slate-50 sm:text-4xl lg:text-[2.8rem]">
                      L&apos;autoconsommation collective{" "}
                      <span className="text-emerald-400">tokenisée</span> pour tous.
                  </h1>
          ...
          <section className="space-y-6">
              ...
              <Card className="space-y-8 border-slate-800 bg-slate-950/80 px-6 py-8 lg:px-10">
                  <div className="space-y-2 text-center">
                      <h2 className="text-xl font-semibold text-slate-50 lg:text-2xl">
          ...
          <section className="space-y-6">
              <div className="flex justify-center">
                  <Badge className="rounded-full bg-emerald-500/10 px-4 py-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-emerald-300">
                      Comment ça marche ?
                  </Badge>
              </div>
          ...
          {/* STATS SECTION */}
          <section className="space-y-6">
              <h2 className="text-center text-lg font-semibold text-slate-50 lg:text-xl">
          ...
          <section className="mb-10">
              <Card className="border-emerald-700/50 bg-gradient-to-r from-emerald-600/20 via-emerald-500/10 to-teal-600/20 px-6 py-10 text-center lg:px-10">
                  <div className="space-y-4">
                      ...
                      <Button className="mt-2 h-10 rounded-full bg-emerald-500 px-6 text-xs font-semibold text-black hover:bg-emerald-400">
